...
class HomeRecyclerAdapter internal constructor(private var category: ArrayList<Category>, private val homeItemClick: HomeItemClick) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.bind(category[position], homeItemClick)
    }
